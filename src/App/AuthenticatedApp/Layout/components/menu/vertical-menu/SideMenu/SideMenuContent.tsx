...
// import { AllowRole } from "./../../../../../../../components/common/ProtectedRoute/ProtectedRoute";
...
//   handleGroupClick = (id: string = "", parent = null, type = "") => {
...
//           }}
//         >
//           <AllowRole roles={item.permissions as string[]}>
//             <Link
//               to={
//                 item.filterBase
//                   ? item.filterBase
...
//         (item.type === "item" &&
//           item.permissions &&
//           item.permissions.some((p) => this.props.currentUser.includes(p))) ||
