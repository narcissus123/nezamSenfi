      ...
      <ul className="menu-content">
        {item.children
          ? item.children.map((child) => {
              ...
              if (IsSameUrl(this.props.activeItemState, child.navLink)) {
                this.childObj = child;
                this.props.parentArr.push(this.parentArray);
                this.flag = false;
              }
              if (
                (child.permissions &&
                  child.permissions.some((p) =>
                    this.props.currentUser.includes(p)
                  )) ||
                ...
                return (
                  <li
                    ...
                    className={classnames({
                      ...
                      active:
                        //IsSameUrl(this.props.activeItemState,child.navLink)
                        (IsSameUrl(this.props.activeItemState, child.navLink) &&
                          child.type === "item") ||
                        (item.parentOf &&
