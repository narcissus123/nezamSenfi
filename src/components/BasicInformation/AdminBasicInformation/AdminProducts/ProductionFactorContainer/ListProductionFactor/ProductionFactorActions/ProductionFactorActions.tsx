...
import { useDeleteJobProductionFactor } from "../../../../../../../core/services/api/job.api";
...
const ProductionFactorActions: React.FC<IPropTypes> = ({
  cell: {
    row: {
      values: { id },
      original
  ...
  const DeleteProductUnitById = useDeleteJobProductionFactor()
  ...
  return (
    <div className="d-flex justify-content-center align-content-center">
      ...
      <Button
        ...
        color="warning"
        onClick={() => {
          history.push("/BasicInformation/Products/ProductsFactor/" + id);
        }}
      >
        ویرایش &nbsp;
        <Edit
      ...
      <Button
        ...
        onClick={() => {
          history.push(
            "/BasicInformation/Products/ProductsFactor/DependencyType/" + id
          );
        }}
      >
        ثبت نوع وابستگی &nbsp;
...
export { ProductionFactorActions };
