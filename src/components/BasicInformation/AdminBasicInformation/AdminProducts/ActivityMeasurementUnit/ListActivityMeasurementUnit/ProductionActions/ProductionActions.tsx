...
import { useDeleteActivityMeasurementUnit, useDeleteProductUnit } from "../../../../../../../core/services/api/job.api";
...
const ProductionActions: React.FC<IPropTypes> = ({
  ...
  const DeleteProductUnitById = useDeleteActivityMeasurementUnit();
