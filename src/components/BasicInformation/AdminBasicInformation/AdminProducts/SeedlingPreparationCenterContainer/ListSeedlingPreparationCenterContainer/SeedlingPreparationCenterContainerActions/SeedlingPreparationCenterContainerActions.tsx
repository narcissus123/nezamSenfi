...
import { useDeleteSeedlingPreparationCenter } from "../../../../../../../core/services/api";
...
const SeedlingPreparationCenterContainerActions: React.FC<IPropTypes> = ({
  cell: {
    row: {
      values: { id },
      original
  ...
  const DeleteProductFigureById = useDeleteSeedlingPreparationCenter();
...
export { SeedlingPreparationCenterContainerActions };
