...
import { useDeleteMachineManufacturerById } from "./../../../../../../../core/services/api";
...
const MachineManufacturerActions: React.FC<IPropTypes> = ({
  cell: {
    row: {
      values: { id },
    },
  ...
  const DeleteMachineManufacturer = useDeleteMachineManufacturerById();
  ...
  return (
    <div className="d-flex justify-content-center align-content-center">
      <SweetAlertCallback
        mutation={DeleteMachineManufacturer}
        title="آیا مطمئنید؟"
        onCancel={() => {
        ...
        onConfirm={() => {
          setShowConfirmation(false);
          DeleteMachineManufacturer.mutate(id, {
            onSuccess: () => {
...
export { MachineManufacturerActions };
