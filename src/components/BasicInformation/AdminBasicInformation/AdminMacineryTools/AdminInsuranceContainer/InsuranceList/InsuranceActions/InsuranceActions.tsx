...
import { useDeleteInsuranceById } from "../../../../../../../core/services/api/admin-machiner-insurance.api";
...
const InsuranceActions: React.FC<IPropTypes> = ({
  cell: {
    row: {
      values: { id },
    },
  ...
  const DeleteInsuranceById = useDeleteInsuranceById();
