...
import { useDeleteSectionProximity } from "../../../../../../../core/services/api/parts-and-facilities.api";
...
const LandAdjacentTypeActions: React.FC<IPropTypes> = ({
  cell: {
    row: {
      values: { id },
      original
  ...
  const DeleteServicesById = useDeleteSectionProximity();
...
export { LandAdjacentTypeActions };
