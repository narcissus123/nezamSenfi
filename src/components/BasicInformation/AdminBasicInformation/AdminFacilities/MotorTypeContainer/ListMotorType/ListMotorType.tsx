...
import { columns } from "./ListMotorTypeColumn";
import { refetchContext } from "../../../../../../core/utils/context/EventContext";
import { Form, Formik } from "formik";
import { Col, Row } from "reactstrap";
import { SimpleTextInput, SubmitButton } from "../../../../../common/Form";
import { useGetEnginePowerByFilter, useGetEngineTypeByFilter } from "../../../../../../core/services/api/parts-and-facilities.api";


const ListMotorType: React.FC = () => {
  ...
  const getList = useGetEngineTypeByFilter();
  const { refetchEvent, setRefetchEvent } = useContext(refetchContext);

  useEffect(() => {
    getList.mutate(filterList);
  }, [pageSize , refetchEvent.engineTypeList]);
