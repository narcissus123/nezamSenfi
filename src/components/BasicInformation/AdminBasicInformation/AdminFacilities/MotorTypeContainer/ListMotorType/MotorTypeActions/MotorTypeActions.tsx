...
import { useDeleteEnginePower, useDeleteEngineType } from "../../../../../../../core/services/api/parts-and-facilities.api";
...
const MotorTypeActions: React.FC<IPropTypes> = ({
  cell: {
    row: {
      values: { id }, 
      original
  ...
  const DeleteServicesById = useDeleteEngineType();
