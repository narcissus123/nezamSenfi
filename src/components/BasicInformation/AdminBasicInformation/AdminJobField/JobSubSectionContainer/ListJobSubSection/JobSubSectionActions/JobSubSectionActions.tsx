...
import { editJobSubSectionValidation } from "../../../../../../../core/validations/admin-job-tools.validation";
  ...
  return (
    <div className="d-flex justify-content-center align-content-center">
      ...
      <EditJobModal
        ...
        job={original}
        schema={editJobSubSectionValidation}
        editJobMutation={useEditJobSubSection}
        refetch={refetch}
      />
      <Button
        style={{ margin: "3px" }}
