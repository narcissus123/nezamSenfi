...
import { editJobClassValidation } from "../../../../../../../core/validations/admin-job-tools.validation";
...
const JobClassActions: React.FC<IPropTypes> = ({
  cell: {
    row: {
      values: { id },
      original,
    ...
    <div className="d-flex justify-content-center align-content-center">
      ...
      {openModal && (
        <EditJobModal
          ...
          job={original}
          schema={editJobClassValidation}
          editJobMutation={useEditJobClass}
          refetch={refetch}
        />
      )}
      <Button
