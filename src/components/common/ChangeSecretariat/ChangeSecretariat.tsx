...
import { isLimitedNumberRegex, showToast } from "../../../core/utils";
import { SubmitButton } from "../Form";
import { InputGroupSearch } from "../Form/InputComponents/InputGroupSearch/InputGroupSearch";
...
const ChangeSecretariat: FC<IPropTypes> = ({
  ...
  const setSecretariat = useMutate();
  ...
  return (
    ...
    >
      <ModalHeader>
        {hasSecretariat ? "تغییر دبیرخانه" : "تخصیص به دبیرخانه"}
      </ModalHeader>
          ...
          <>
            <Form>
              ...
              <ModalFooter className="justify-content-start">
                <SubmitButton
                  isLoading={setSecretariat.isLoading}
                  btnText="ثبت"
                  clearable
                  clearableDisable={setSecretariat.isLoading}
                  clearableTxt="انصراف"
                  onClear={toggleModal}
                />
              </ModalFooter>
