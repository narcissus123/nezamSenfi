...
import { useServePayableValueDocument, useServePayableValueDocumentOfSharingPercent, useServeTariffDocument } from "../../../../../../core/services/api";
...
const Actions: React.FC<IPropTypes> = ({
  ...
  const serveFiles = useServePayableValueDocumentOfSharingPercent()
