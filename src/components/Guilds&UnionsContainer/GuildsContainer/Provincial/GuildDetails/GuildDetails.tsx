...
import {
  useGetProvinceGuildRoomDetails, usePostGetProvinceGuildRoomPosition, usePostGetProvinceGuildRoomPositionRequestHistoryByFilter,
...
const GuildDetails: FC = () => {
  ...
  return (
    <TabContainer
      ...
      type="Province"
      getDetailsMutation={useGetProvinceGuildRoomDetails}
    />
  );
};
