...
const OwnedSearch: FC<IPropTypes> = ({
  ...
  const ProvinceUrls = [
    ...
    "/GuildsActivation/CountyItManagerCartable",
    "/GuildsActivation/ProvinceItManagerCartable",
    ...
    "/UnionsActivation/UnionSecretariatCartable",
    "/UnionsActivation/UnionSecretariatActivation",
    "/UnionsActivation/UnionItManagerCartable",
  ];
