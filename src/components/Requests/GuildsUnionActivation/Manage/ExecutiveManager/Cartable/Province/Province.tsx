...
import {
  useGetAllprovinces,
  useGetExecutiveManagerCartableOfProvinceGuildRoomRequests,
} from "../../../../../../../core/services/api";
import { ManagerList } from "../../../Manager/GuildActivationList/ManagerList/ManagerList";
import { columns } from "./Column";

const Province: FC = () => {
  const getProvinceCartable = useGetExecutiveManagerCartableOfProvinceGuildRoomRequests();
  ...
  return (
    <ManagerList
      ...
      getCustomProps={{ flow: "ProvinceExecutiveManagerFlow" }}
      isAllGuildRoom
    />
  );
};
