...
import {
  ...
  useGetExecutiveManagerCartableOfUnionRequests,
} from "../../../../../../../core/services/api";
import { ManagerList } from "../../../Manager/GuildActivationList/ManagerList/ManagerList";
import { columns } from "./Column";

const Union: FC = () => {
  const getCartable = useGetExecutiveManagerCartableOfUnionRequests();
  ...
  return (
    <ManagerList
      ...
      getCustomProps={{ flow: "UnionExecutiveManagerFlow" }}
    />
  );
};
