...
import { useGetOwnedUserUnionForUnionUnionIssuingResponsible } from "../../../../../core/services/api";
import { ListTable } from "../../../../common/ListTable/ListTable";
import { useGetAllIdentityChangeRequestByIssuingResponsible } from "../../../../../core/services/api/change-user-identity-request.api";
...
const CartableContainer: FC = () => {
  ...
  const getListMutation = useGetAllIdentityChangeRequestByIssuingResponsible();
  const { data, isSuccess, isFetching }  = useGetOwnedUserUnionForUnionUnionIssuingResponsible()
          ...
          <Card>
            ...
            <CardBody>
              <ListTable
                ...
                getCustomProps={{ flow: "IssuingResponsibleIdentityChangeFlow" }}
              >
                {{
                  headerTable: <p></p>,
                }}
