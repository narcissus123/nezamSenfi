...
import { ProvinceUploadInquiryFiles } from "./ProvinceUploadInquiryFiles/ProvinceUploadInquiryFiles";

export interface JobRequestProps {}

const Province: React.FC<JobRequestProps> = () => {
  ...
  return (
    <>
      <BreadCrumbs
        ...
        parentLink2="/Requests/ProvinceJobRequest/List"
              ...
              <NavItem>
                <NavLink
                  className={classnames({
                    active: IsSameUrl(
                      location.pathname,
                      `/Requests/job/province/${status}/Details/${req_id[0]}`
                    ),
                  })}
                  onClick={() => {
                    history.push(
              ...
              <NavItem>
                <NavLink
                  ...
                  className={classnames({
                    active: IsSameUrl(
                      location.pathname,
                      `/Requests/job/province/${status}/UploadDocuments/${req_id[0]}`
                    ),
                  })}
                  onClick={() => {
                    history.push(
              ...
              <NavItem>
                <NavLink
                  ...
                  className={classnames({
                    active: IsSameUrl(
                      location.pathname,
                      `/Requests/job/province/${status}/UploadInquiry/${req_id[0]}`
                    ),
                  })}
                  onClick={() => {
                    history.push(
            ...
            <TabContent className="py-50" activeTab={toggle}>
              <Switch>
                <SimpleProtectedRoute
                  component={Details}
                  path="/Requests/job/province/:status/Details/:req_id"
                  flow="ProvinceJobRequestFlow"
                  status={0}
                  exact
                />
                <SimpleProtectedRoute
                  component={EditCV}
                  path="/Requests/job/province/:status/UploadDocuments/:req_id/cv/:cv_id"
                  flow="ProvinceJobRequestFlow"
                  status={1}
                  exact
                />
                <SimpleProtectedRoute
                  ...
                  path="/Requests/job/province/:status/UploadDocuments/:req_id"
                  flow="ProvinceJobRequestFlow"
                  status={1}
                  exact
                />
                <SimpleProtectedRoute
                  component={ProvinceUploadInquiryFiles}
                  path="/Requests/job/province/:status/UploadInquiry/:req_id"
                  flow="ProvinceJobRequestFlow"
                  status={12}
                  exact
                />
