...
import { usePostGetMyProvincePositionRequestsByFilter } from "../../../../../../core/services/api";
...
const ProvinceJobRequestsList: FC = () => {
  ...
  const getListMutation = usePostGetMyProvincePositionRequestsByFilter();
  const { refetchEvent, setRefetchEvent } = useContext(refetchContext);

  useEffect(() => {
    getListMutation.mutate({ ...filterState, page: 1, pageSize: pageSize });
  }, [refetchEvent.provinceJobRequestList, pageSize]);
...
export { ProvinceJobRequestsList };
