...
import { ICountyPositionRequest } from "../../../../../../core/models";
import {
...
import { JobFlowCountyDetailsValidate } from "../../../../../../core/validations/jobflow-county-details.validations";
...
const CountyAddRequest = () => {
  ...
  const onSubmit = (value: any) => {
    ...
    positionRequestMutation.mutate(PositionRequestObject, {
      onSuccess: (val) => {
        ...
        history.push("/Requests/job/county/1/UploadDocuments/" + id);
  ...
  return (
    <>
      ...
      <Card>
        <CardHeader>
          <CardTitle>درخواست شغل شهرستانی</CardTitle>
        </CardHeader>
        <CardBody>
          <Formik
            enableReinitialize={true}
            initialValues={initialValues}
            validationSchema={JobFlowCountyDetailsValidate}
            onSubmit={onSubmit}
          >
            {({
              values,
                ...
                <Form>
                  <>
                      ...
                      <Col md="6">
                        ...
                        <Row>
                          <Col>
                            <BasicSelectOption
                              significant
                              isDisabled={values.county ? false : true}
                    ...
                    <SubmitButton
                      ...
                      schema={JobFlowCountyDetailsValidate}
                      values={values}
