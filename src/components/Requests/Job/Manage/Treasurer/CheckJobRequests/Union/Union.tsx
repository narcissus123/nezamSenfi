...
import { useGetCountyUnionPositionRequestDetailsByIdByTreasurer } from "../../../../../../../core/services/api";
...
const Union: React.FC<IPropsType> = ({ isTreasurerCartable = false }) => {
  const unionPositionDetailsMutation =
    useGetCountyUnionPositionRequestDetailsByIdByTreasurer();
