...
import { useGetProvinceGuildRoomPositionRequestDetailsByIdByTreasurer } from "../../../../../../../core/services/api";
...
const Province: React.FC<IPropsType> = ({ isTreasurerCartable = false }) => {
  const provincePositionDetailsMutation =
    useGetProvinceGuildRoomPositionRequestDetailsByIdByTreasurer();
    ...
    provincePositionDetailsMutation.mutate(id, {
      onSuccess: (val: any) => {
        ...
        const details = {
          ...
          provinceGuildRoomPositionId: data.positionRequestId,
          amount: data.amount,
          debt: data.debt,
