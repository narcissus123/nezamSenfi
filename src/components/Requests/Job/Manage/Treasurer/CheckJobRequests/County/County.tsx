...
import { useGetCountyGuildRoomPositionRequestDetailsByIdByTreasurer } from "../../../../../../../core/services/api";
...
const County: React.FC<IPropsType> = ({ isTreasurerCartable = false }) => {
  const countyPositionDetailsMutation =
    useGetCountyGuildRoomPositionRequestDetailsByIdByTreasurer();
    ...
    countyPositionDetailsMutation.mutate(id, {
      onSuccess: (val: any) => {
        ...
        const details = {
          ...
          countyGuildRoomPositionId: data.positionRequestId,
          amount: data.amount,
          debt: data.debt,
