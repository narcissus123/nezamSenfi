...
import {
  useGetAllPositionRequestInCountyGuildRoomByFilterForExecutiveManager,
  useGetOwnedUserCountyGuildRoomsForExecutiveManager,
} from "../../../../../../../core/services/api";
import { SecretariatList } from "../../../Secretariat/JobRequestslist/SecretariatList/SecretariatList";
import { columns } from "./Column";

const County: FC = () => {
  const getAllCountyPosition = useGetAllPositionRequestInCountyGuildRoomByFilterForExecutiveManager();

  const getOwnedCountyGuildRoom = useGetOwnedUserCountyGuildRoomsForExecutiveManager();
  ...
  return (
    <SecretariatList
      ...
      getCustomProps={{ flow: "CountyExecutiveManagerJobRequestFlow" }}
    />
  );
};
