...
import {
  useGetAllPositionRequestInCountyUnionByFilterForExecutiveManager,
  useGetOwnedUserUnionForUnionExecutiveManager,
} from "../../../../../../../core/services/api";
import { SecretariatList } from "../../../Secretariat/JobRequestslist/SecretariatList/SecretariatList";
import { columns } from "./Column";

const Union: FC = () => {
  const getAllUnionPosition = useGetAllPositionRequestInCountyUnionByFilterForExecutiveManager();

  const getOwnedUnionGuildRoom = useGetOwnedUserUnionForUnionExecutiveManager();
  ...
  return (
    <SecretariatList
      ...
      getCustomProps={{ flow: "UnionExecutiveManagerJobRequestFlow" }}
    />
  );
};
