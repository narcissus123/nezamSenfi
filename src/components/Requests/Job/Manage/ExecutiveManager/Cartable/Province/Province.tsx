...
import {
  useGetAllPositionRequestInProvinceGuildRoomByFilterForExecutiveManager,
...
const Province: FC = () => {
  const getAllProvincePosition = useGetAllPositionRequestInProvinceGuildRoomByFilterForExecutiveManager();

  const getOwnedProvinceGuildRoom = useGetOwnedUserProvinceGuildRoomsExecutiveManager();
