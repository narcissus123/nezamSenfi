...
import {
  useGetAllPositionRequestInMainLocationGuildRoomByFilterForExecutiveManager,
...
const MainLocation: FC = () => {
  const getAllMainLocationPosition = useGetAllPositionRequestInMainLocationGuildRoomByFilterForExecutiveManager();
  ...
  return (
    <SecretariatList
      ...
      getCustomProps={{ flow: "MainLocationExecutiveManagerJobRequestFlow" }}
    />
  );
};
