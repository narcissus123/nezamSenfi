...
import {
  useGetAllPositionRequestInProvinceGuildRoomByFilterForViceManager,
...
const Province: FC = () => {
  const getAllProvincePosition = useGetAllPositionRequestInProvinceGuildRoomByFilterForViceManager();
