...
import { useGetProvinceGuildRoomPositionRequestDetailsByIdByUpManager, usePostConfirmProvinceGuildRoomPositionRequestByUpLevelManger, usePostGetResumesInProvinceGuildRoomPositionRequestByFilterByUpManager, usePostRejectProvinceGuildRoomPositionRequestByUpLevelManger } from "../../../../../../../../core/services/api";
...
const ProvinceManagerDetails: React.FC<IPropsType> = ({
  isSecretariatCartable = false,
  isManagerCartable = false,
}) => {
  const countyPositionDetailsMutation = useGetProvinceGuildRoomPositionRequestDetailsByIdByUpManager();
  const resumeMutation = usePostGetResumesInProvinceGuildRoomPositionRequestByFilterByUpManager();
  ...
  return (
    <>
      <UpManagerCheckJobRequest
        ...
        rejectMutation={usePostRejectProvinceGuildRoomPositionRequestByUpLevelManger}
        confirmMutation={usePostConfirmProvinceGuildRoomPositionRequestByUpLevelManger}
      />
    </>
  );
};

export { ProvinceManagerDetails };
