...
import { useGetCountyUnionPositionRequestDetailsByIdByUpManager, usePostConfirmCountyUnionPositionRequestByUpLevelManger, usePostGetResumesInCountyUnionPositionRequestByFilterByUpManager, usePostRejectCountyUnionPositionRequestByUpLevelManger } from "../../../../../../../../core/services/api";
...
const UnionManagerDetails: React.FC<IPropsType> = ({
  isSecretariatCartable = false,
  isManagerCartable = false,
}) => {
  const countyPositionDetailsMutation = useGetCountyUnionPositionRequestDetailsByIdByUpManager();
  const resumeMutation = usePostGetResumesInCountyUnionPositionRequestByFilterByUpManager();
  ...
  return (
    <>
      <UpManagerCheckJobRequest
        ...
        rejectMutation={usePostRejectCountyUnionPositionRequestByUpLevelManger}
        confirmMutation={usePostConfirmCountyUnionPositionRequestByUpLevelManger}
      />
    </>
  );
};

export { UnionManagerDetails };
