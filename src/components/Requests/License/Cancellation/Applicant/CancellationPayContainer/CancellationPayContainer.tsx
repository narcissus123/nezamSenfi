...
import { CurrencyMask, IsIncludes, RemoveCurrencyMask, showToast } from "../../../../../../core/utils";
...
import Styled from './CancellationPayContainer.module.scss'
...
const CancellationPayContainer: FC<IPropTypes> = ({
  getRequestRate,
  payMutation,
  redirectLink,
  title,
...
export { CancellationPayContainer };
