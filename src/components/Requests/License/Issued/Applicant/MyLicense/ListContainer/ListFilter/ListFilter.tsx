...
const ListFilter: React.FC<IPropsProps> = ({
  ...
  const [isValidData, setIsValiddata] = useState<any>([
    {
      label: "انتخاب کنید...",
      options: [
  ...
  const [finalLicenseStatusEnumData, setFinalLicenseStatusEnumData] =
    useState<any>([
      {
        label: "انتخاب کنید...",
        options: [
          { value: LicenseFinalStatusEnum.Issued, label: "صدور" },
          { value: LicenseFinalStatusEnum.Extended, label: "تمدید شده" },
          { value: LicenseFinalStatusEnum.Changed, label: "تغییر شده" },
          { value: LicenseFinalStatusEnum.Finished, label: "پایان یافته" },
        ],
      },
    ]);
  ...
  return (
    <>
      ...
      <Row>
        ...
        <Col lg="3">
          <BasicSelectOption
            lableText="وضعیت پروانه"
            placeHolder="انتخاب کنید..."
            name="finalLicenseStatusEnum"
            data={finalLicenseStatusEnumData}
            isLoading={false}
          />
        </Col>
      </Row>
