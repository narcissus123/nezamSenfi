...
import { useSetLicenseRequestVisitDateByExpert } from "../../../../../../../core/services/api";
import {
...
const SetVisitDateModal: FC<IPropTypes> = ({ isOpen, toggleModal }) => {
  ...
  const setDate = useSetLicenseRequestVisitDateByExpert();
  ...
  return (
    ...
    >
      <ModalHeader toggle={toggleModal}>اعلام قرار بازدید</ModalHeader>
      <Formik
        initialValues={{
          description: "",
          date: "",
