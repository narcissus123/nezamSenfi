...
import {
  ...
  useGetLicenseRequestExpertIdeaByIssuingResponsible,
  useGetLicenseRequestRequiredTabsByIssuingResponsible,
  useGetOwnershipOfLicenseRequestByIssuingResponsible,
  useGetSectionLicenseRequestSectionExpertIdeaByIssuingResponsible,
              ...
              <Nav tabs className="nav-justified">
                  ...
                  <NavItem>
                    <NavLink
                      className={classnames({
                        active: IsSameUrl(
                          location.pathname,
                          `/IssueingResponsible/Inspection/${status}/Land/${req_id[0]}/${section_id[0]}`
                        ),
                      })}
                      onClick={() => {
                        history.push(
                  ...
                  <NavItem>
                    <NavLink
                      className={classnames({
                        active: IsSameUrl(
                          location.pathname,
                          `/IssueingResponsible/Inspection/${status}/GeographicalLocation/${req_id[0]}/${section_id[0]}`
                        ),
                      })}
                      onClick={() => {
                        history.push(
                  ...
                  <NavItem>
                    <NavLink
                      ...
                      className={classnames({
                        active: IsSameUrl(
                          location.pathname,
                          `/IssueingResponsible/Inspection/${status}/DistancesBoundaries/${req_id[0]}/${section_id[0]}`
                        ),
                      })}
                      onClick={() => {
                        history.push(
                ...
                {tabs.some(
                  ...
                  <NavItem>
                    <NavLink
                      ...
                      onClick={() => {
                        history.push(
                          `/IssueingResponsible/Inspection/${status}/Topography/${req_id[0]}/${section_id[0]}`
                        );
                      }}
                      className={classnames({
                        active: IsSameUrl(
                ...
                {tabs.some(
                  ...
                  <NavItem>
                    <NavLink
                      onClick={() => {
                        history.push(
                          `/IssueingResponsible/Inspection/${status}/Facilities/${req_id[0]}/${section_id[0]}`
                        );
                      }}
                      className={classnames({
                        active: IsIncludes(
                ...
                {tabs.some(
                  ...
                  <NavItem>
                    <NavLink
                      ...
                      onClick={() => {
                        history.push(
                          `/IssueingResponsible/Inspection/${status}/TreeSpecifications/${req_id[0]}/${section_id[0]}`
                        );
                      }}
                      className={classnames({
                        active: IsSameUrl(
                ...
                {tabs.some(
                  ...
                  <NavItem>
                    <NavLink
                      ...
                      onClick={() => {
                        history.push(
                          `/IssueingResponsible/Inspection/${status}/ServicesStatus/${req_id[0]}/${section_id[0]}/consulting`
                        );
                      }}
                      className={classnames({
                        active:
                          ...
                          IsSameUrl(
                            location.pathname,
                            `/IssueingResponsible/Inspection/${status}/ServicesStatus/${req_id[0]}/${section_id[0]}/mechanisation`
                          ) ||
                          IsSameUrl(
                            location.pathname,
                            `/IssueingResponsible/Inspection/${status}/ServicesStatus/${req_id[0]}/${section_id[0]}/alterantindustries`
                          ) ||
                          IsSameUrl(
                            location.pathname,
                            `/IssueingResponsible/Inspection/${status}/ServicesStatus/${req_id[0]}/${section_id[0]}/merchantservices`
                          ),
                      })}
                    >
                      ارائه خدمات و تولید
                ...
                {tabs.some(
                  ...
                  <NavItem>
                    <NavLink
                      ...
                      onClick={() => {
                        history.push(
                          `/IssueingResponsible/Inspection/${status}/ConsumptionStatus/${req_id[0]}/${section_id[0]}`
                        );
                      }}
                      className={classnames({
                        active: IsSameUrl(
                ...
                {tabs.some(
                  ...
                  <NavItem>
                    <NavLink
                      ...
                      onClick={() => {
                        history.push(
                          `/IssueingResponsible/Inspection/${status}/Capacity/${
                            req_id[0]
                ...
                <NavItem>
                  <NavLink
                    ...
                    onClick={() => {
                      history.push(
                        `/IssueingResponsible/Inspection/${status}/Description/${
                          req_id[0]
                        }${section_id[0] !== "0" ? `/${section_id[0]}` : ""}`
                      );
                    }}
              ...
              <TabContent className="py-50">
                <Switch>
                  <SimpleProtectedRoute
                    ...
                    path="/IssueingResponsible/Inspection/:status/Land/:req_id/:section_id"
                    exact
                  />
                  <SimpleProtectedRoute
                    component={() =>
                    ...
                    path="/IssueingResponsible/Inspection/:status/GeographicalLocation/:req_id/:section_id"
                    exact
                  />
                  <SimpleProtectedRoute
                    component={() =>
                    ...
                    path="/IssueingResponsible/Inspection/:status/Topography/:req_id/:section_id"
                    exact
                  />
                  <SimpleProtectedRoute
                    component={() =>
                    ...
                    path="/IssueingResponsible/Inspection/:status/Capacity/:req_id/:section_id?"
                    exact
                  />
                  <SimpleProtectedRoute
                    component={() =>
                    ...
                    path="/IssueingResponsible/Inspection/:status/TreeSpecifications/:req_id/:section_id"
                    exact
                  />
                  <SimpleProtectedRoute
                    component={() =>
                    ...
                    path="/IssueingResponsible/Inspection/:status/Facilities/:req_id/:section_id"
                    exact
                  />
                  <SimpleProtectedRoute
                    component={() =>
                        ...
                        <>
                          ...
                          mechanizationServicesIsFetching ? (
                            ...
                            <ServicesStatus
                              ...
                              isExpert={false}
                              screen="/IssueingResponsible"
                            />
                          )}
                        </>
                      )
                    }
                    path="/IssueingResponsible/Inspection/:status/ServicesStatus/:req_id/:section_id"
                  />
                  <SimpleProtectedRoute
                    component={() =>
                      onLazyTabsLoad(
                    ...
                    path="/IssueingResponsible/Inspection/:status/ConsumptionStatus/:req_id/:section_id"
                    exact
                  />
                  <SimpleProtectedRoute
                    component={() =>
                    ...
                    path="/IssueingResponsible/Inspection/:status/DistancesBoundaries/:req_id/:section_id"
                    exact
                  />
                  ...
                  <SimpleProtectedRoute
                    ...
                    path="/IssueingResponsible/Inspection/:status/Description/:req_id/:section_id?"
                    exact
                  />
                </Switch>
              </TabContent>
