...
const ChangeIssueingResponsible: FC<IPropTypes> = ({
  isOpen,
  toggleModal,
  // hasSecretariat,
  useMutate,
  ...
  const onSubmit = (values: any) => {
    ...
    if (userInfo) {
      setUser.mutate(
        {
          licenseRequestId: id,
          issuingResponsibleId: userInfo.id,
        },
        {
          onSuccess: () => {
  ...
  return (
    ...
    >
      <ModalHeader toggle={toggleModal}>تغییر مسئول صدور</ModalHeader>
...
export { ChangeIssueingResponsible };
