...
import Style from './SectionPlanContainer.module.scss';
...
const SectionPlanContainer: FC<IPropTypes> = ({
  getMutation
}) => {
                        ...
                        <td>
                          <table style={{ width: "260px" }}>
                            <tr>
                              ...
                              <td>
                                {
                                  details.licenseInfo.sectionInfos[0].topography
                                    .topographyStatus
                                }
                              </td>
                            </tr>
