...
import Styled from "./UserLegalContactInfo.module.scss";

interface IPropTypes {
  id: string;
}

const UserLegalContactInfo: React.FC<IPropTypes> = ({ id }) => {
  const { data, isFetching, isSuccess } = useUserLegalContactById(+id);
                          ...
                          <CardBody>
                            <TwoColumn>
                              <div>
                                ...
                                />
                                <TextArea
                                  lableText="آدرس دقیق پستی محل شرکت"
                                  name={`addresses.${index}.address`}
                                  placeholder="آدرس دقیق پستی محل شرکت"
                                  disabled
                                />
                              </div>
                              ...
                              <div>
                                <TextInput
                                  lableText="تلفن محل شرکت"
                                  name={`addresses.${index}.homePhone`}
                                  type="tell"
                                  placeholder="تلفن محل شرکت"
                                  disabled
                                />
                                <TextInput
                                  lableText="کد پستي محل شرکت"
                                  name={`addresses.${index}.postalCode`}
                                  placeholder="کد پستي محل شرکت"
                                  disabled
                                />
