...
import { useDeleteJahadCenter } from "../../../../core/services/api/jahad-center.api";
...
const Actions: React.FC<IPropTypes> = ({
  ...
  const removeMutation = useDeleteJahadCenter()
  ...
  const deleteClickHandler = (id : any) => {
    ...
    swalWithBootstrapButtons
      .fire({
        title: "ایا مایل به حذف مرکز جهاد هستید؟",
        icon: "warning",
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        onClick={() => {
          history.push({
            pathname: "/JahadCenter/Users/" + id,
            state: { jahadCenterTitle: title },
          });
        }}
      >
        کاربران &nbsp;
