...
const JobFlowUnionDetailsValidate = Yup.object().shape({
  // province: Yup.object()
  //   .required()
  //   .test(
  //     "province",
...
const EditJobFlowUnionDetailsValidate = Yup.object().shape({
  rankStatus: Yup.object()
    .required()
    .test(
      "rankStatus",
...
export { JobFlowUnionDetailsValidate, EditJobFlowUnionDetailsValidate };
